...
const TABLE = {
  ...
  // ---- progression, goals and the World Passport ----
  progress: { sv: "Framsteg", en: "Progress" },
  toUnlock: { sv: "%n poäng till %s", en: "%n points to %s" },
  allUnlocked: { sv: "Alla teman upplåsta", en: "Every theme earned" },
  nextGoal: { sv: "Nästa mål", en: "Next goal" },
  goalDepth: { sv: "Nå djup %n", en: "Reach depth %n" },
  goalRingCount: { sv: "Rensa %n ringar i en omgång", en: "Clear %n rings in one round" },
  goalComboCount: { sv: "Nå kombo %n", en: "Reach a combo of %n" },
  ...
  worldsFound: { sv: "%n av %m världar", en: "%n of %m worlds" },
  nextWorldUp: { sv: "Nästa värld", en: "Next world" },
  chooseGoal: { sv: "Välj ett mål", en: "Choose a goal" },
  masteryGoal: { sv: "Mästerskapsmål", en: "Mastery goal" },
  masteryDone: { sv: "Mål klarat!", en: "Goal complete!" },
  noGoalYet: { sv: "Inget mål valt", en: "No goal chosen" },
  progressBonus: { sv: "Framstegsbonus — inte topplistepoäng", en: "Progress bonus — not leaderboard points" },
  playAgainNow: { sv: "Spela igen direkt", en: "Play again" },
  worldFound: { sv: "%s upptäckt", en: "%s discovered" },
  toRecord: { sv: "%n poäng till ditt rekord", en: "%n points to your record" },
  newRecord: { sv: "Nytt rekord", en: "New record" },
  recDepth: { sv: "Djup", en: "Depth" },
  recScore: { sv: "Poäng", en: "Score" },
  recSurvived: { sv: "Överlevde", en: "Survived" },
  recCombo: { sv: "Kombo", en: "Combo" },
  recCores: { sv: "Kärnor", en: "Cores" },
  recRings: { sv: "Ringar", en: "Rings" },
  musicOn: { sv: "Musik", en: "Music" },
